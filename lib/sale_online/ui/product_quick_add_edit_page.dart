...
import 'package:tpos_mobile/sale_online/viewmodels/product_quick_add_edit_viewmodel.dart';
...
class _ProductQuickAddEditPageState extends State<ProductQuickAddEditPage> {
  ...
  ProductQuickAddEditViewModel viewModel = new ProductQuickAddEditViewModel();
  ...
  Widget _showBody() {
    return new StreamBuilder<Product>(
